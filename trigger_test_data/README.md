...
2. altitude is high, pressure values wierd (this will need to be tested in multiple cases (sensor has no readings, sensor readings are inconsistent in many ways))
