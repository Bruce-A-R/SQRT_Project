...
Version Date: 11/4/2026

Description from UCD: 
...
#        super().__init__(uart, address, user_callback)
    ...
    def send_telemetry(self, hhmmss=None, latitude=None, longitude=None, altitude=None, hdop=None,
        ...
        error_count = 0.0 if error_count is None else int(error_count)
        error_type = 0.0 if error_type is 'None' else error_type
