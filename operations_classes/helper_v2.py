...
this script contains class Helper 

Helper contains functions useful for interfacing between the pico and sd card, 
initializing sensors, and handling data onboard the pico. 
...
class Helper:
    ...
    def write_science_frames(self, science_frames, science_times, file_list):
        ...
        """
        # now writing a seperate file with the times of all post trigger frames
        # this is done so we can save all the frames as arrays of bytes
        ...
        try:
                with open(file_list[4], "wb") as f:
                    ...
                    #for i, line in enumerate(science_frames):
