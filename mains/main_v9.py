...
Overview of main function (14/4/2026 CK and BR)
...
while True:
    ...
    if not trigger:
        ...
        if trigger:
            ...
            print(f"MEM ALOC PRE TRIGGER OPS: {gc.mem_alloc()}")
            ...
            for i in range(16):
                # getting 16 science frames in a row right after the servo triggers. We expect about 4 to be during flash evaporation
                try:
