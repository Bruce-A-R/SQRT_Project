"""
version 4 of of main function with triggering and servo included included
still has old file system
"""
    ...
    for fname in file_list:
        with open(fname, 'w') as f:
            if 'ms5611' in fname:
                ...
                f.write("Timestamp (s), Trigger, Trigger Condition, Pressure, Altitude, Triggering Error \n")
